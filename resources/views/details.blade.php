            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5 carde">
                    <form method="POST" action="{{ route('details.store') }}" enctype="multipart/form-data" class="text-center" style="color: #757575;">
                        ...
                        <div class="md-form">
                            <input type="number" name="duree" id="duree" class="form-control champs" required>
                        ...
                        <div class="md-form">
                            <input type="text" name="nom" id="nom" class="form-control champs">
                            <label for="nom">Nom</label>
                            <div class="invalid-feedback"></div>
                        </div>

                        <div class="md-form">
                            <input type="text" name="prenom" id="prenom" class="form-control champs">
                            <label for="prenom">Prenom</label>
                            <div class="invalid-feedback"></div>
                        </div>

                        <div class="md-form">
                            <input type="text" name="telephone" id="telephone" class="form-control champs">
                            <label for="telephone">Telephone</label>
                            <div class="invalid-feedback"></div>
                        </div>

                        <div class="md-form">
                            <input type="text" name="adresse" id="adresse" class="form-control champs">
